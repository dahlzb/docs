const baiduCode = require("./configs/baiduCode.js"); // 百度统计hm码
const htmlModules = require("./configs/htmlModules.js");
...
module.exports = {
	...
	themeConfig: {
		...
		repo: "dahlzb/docs", // 导航栏右侧生成Github链接
	...
	// 监听文件变化并重新构建
	extraWatchFiles: [".vuepress/config.js", ".vuepress/configs/htmlModules.js"],
};
